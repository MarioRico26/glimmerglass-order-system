...
export default function NewOrderPage() {
  ...
  const selectedModel = useMemo(() => models.find((m) => m.id === poolModelId) ?? null, [models, poolModelId])
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="rounded-2xl border border-white bg-white/80 backdrop-blur-xl shadow-lg p-6">
        <h1 className="text-2xl font-black text-slate-900 mb-4">New Order</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Pool Model, Color, Factory, Delivery Address, Notes, Payment Proof */}
          {/* Puedes reinsertar tus componentes anteriores aquí según tus datos existentes */}
          ...
          <div>
            <button
              type="submit"
              disabled={submitting}
              className="w-full inline-flex items-center justify-center h-11 rounded-xl text-white font-semibold shadow-lg transition-transform active:scale-[0.99] disabled:opacity-70"
